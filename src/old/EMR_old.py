...
class EMR_old:
    ...
    def generate_Zspec(self, freq, paras):
...
# freq = 128*np.array([80, 60, 40, 30, 20, 12, 8, 4, 3.5, 3, 2.5, 2, 1.5])
# paras = [3, 0.5, 15, 8e-6] # [R, R*M0m*T1w, T1w/T2w, T2m]
# model = EMR_fitting()
# model.set_lineshape("SL")
# Zspec = model.generate_Zpsec(freq, paras)
# plt.scatter(freq/128, Zspec)
# plt.ylim((0, 1))
